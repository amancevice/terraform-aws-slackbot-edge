...
from .aws import EventBus, SigV4ASigner
from .errors import Forbidden
from .logger import logger


class Slackbot:
    def __init__(self, event_bus=None, oauth=None, signer=None, sigv4a=None):
        self.event_bus = event_bus or EventBus()
        self.oauth = oauth or OAuth()
        self.signer = signer or Signer()
        self.sigv4a = sigv4a or SigV4ASigner()
    ...
    def resolve(self, event):
        ...
        # Resolve
        result = self.sigv4a.resolve(request, data)
        return result
